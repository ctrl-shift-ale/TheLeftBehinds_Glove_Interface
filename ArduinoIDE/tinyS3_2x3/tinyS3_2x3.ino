...
const char* SSIDS[] = {"LeftBehinds", "OtherNetwork_SSID"};
const char* PASSWORDS[] = {"DontLeaveMeBehind", "OtherNetwork_PW"};
...
int ins[] = {FLEXO_0, FLEXO_1, BUTTON_0, BUTTON_1, BUTTON_2}; // this is the routing for TINYS3_BUILT_1
